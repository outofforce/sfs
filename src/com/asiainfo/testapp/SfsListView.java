...
public class SfsListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        //setCacheColorHint(context.getResources().getColor(R.color.main_blue));
        inflater = LayoutInflater.from(context);
        headView = (LinearLayout) inflater.inflate(R.layout.sfs_listvewhead, null);
    ...
    public void onRefreshComplete() {
        state = DONE;
        lastUpdatedTextView.setText("上次刷新时间 " + new Date().toLocaleString());
        changeHeaderViewByState();
    }
    ...
    public void setAdapter(BaseAdapter adapter) {
        lastUpdatedTextView.setText("刷新时间:" + new Date().toLocaleString());
